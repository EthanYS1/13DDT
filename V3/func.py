...
def listing (root, listing_y,image_path,food_text, ingred, main_txt, cost, itemid):
 #Input for the restraunt side to put in info about the item   
    def item_selected():
        global current_item
...
def review():    
    if current_item == 1:
        print("Current item is 1")
    elif current_item == 2:
        print("Current item is 2")    
